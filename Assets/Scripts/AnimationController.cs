...
public class AnimationController : MonoBehaviour
{
    ...
    public void ChangeBoolState(string parameter, bool state)
    {
        _animator.SetBool(parameter, state);
    }

    public void CallTriggerState(string parameter)
    {
        _animator.SetTrigger(parameter);
    }

    public void ChangeFloatState(string parameter, float value)
    {
